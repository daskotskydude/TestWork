...
export default function BuyerRegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Mock registration - just navigate to buyer dashboard
    console.log('Mock buyer registration:', formData)
        ...
        <CardContent>
          ...
          <div className="mt-6 p-3 bg-yellow-50 dark:bg-yellow-950 rounded-lg border border-yellow-200 dark:border-yellow-800">
            <p className="text-xs text-yellow-800 dark:text-yellow-200">
              ...
              Submitting will take you directly to the buyer dashboard. Supabase authentication 
